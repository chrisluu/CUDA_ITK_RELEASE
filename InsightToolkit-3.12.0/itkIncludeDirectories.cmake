...
IF (NOT CUDA_SDK_DIR)
	IF(UNIX)
		SET(CUDA_SDK_DIR "/home/tom/NVIDIA_CUDA_SDK"	# tw-	Is there a cMake Variable for homedirectory???
...
SET(CUDA_INC_PATH ${CUDA_INCLUDE_DIR} ${CUDA_SDK_DIR}/common/inc)

#MESSAGE("CUDA_INC_DIR : " ${CUDA_INC_PATH})
