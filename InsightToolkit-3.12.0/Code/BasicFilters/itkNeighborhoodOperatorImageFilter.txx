/*=========================================================================
  ...
  Module:    $RCSfile: itkNeighborhoodOperatorImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkNeighborhoodOperatorImageFilter_txx
#define __itkNeighborhoodOperatorImageFilter_txx
                       ...
                       int threadId)
{
  ...
  if( checkCUDA() )
  {
  	...
  	//typedef typename itk::NeighborhoodOperator<OperatorValueType,
    //            itkGetStaticConstMacro(ImageDimension), typename OutputNeighborhoodType::AllocatorType> NHOperatorType;
    //typedef typename itk::NeighborhoodOperator<OperatorValueType,
    //           itkGetStaticConstMacro(ImageDimension)> OperatorType;
   //	OperatorType *op = &((OperatorType ) m_Operator);
    
    std::cout << "Calling cudaDerivateImageFilter..." << std::endl;
    cudaDerivativeImageFilter<InputImageType, OutputImageType, OutputNeighborhoodType>(input, output, *m_Operator);   
  }
  else
  {
