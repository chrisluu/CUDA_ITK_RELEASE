...
public:
  ...
  // wk--
  typedef DiscreteGaussianImageFilter< InputImageType, RealImageType >  DiscreteGaussFilterType;
  typedef typename DiscreteGaussFilterType::Pointer DiscreteGaussianFilterPointer;
   
  typedef DerivativeImageFilter< RealImageType, RealImageType >  DerivativeFilterType;
  typedef typename DerivativeFilterType::Pointer DerivativeFilterPointer[2];
...
private:
  ...
  DiscreteGaussianFilterPointer m_DiscreteGaussianFilter;
